...
public struct SpeculativeConfig: Sendable {
    ...
    public init(enabled: Bool = false, draftModel: String? = nil,
...
public struct ModelConfig: Codable, Sendable {
    ...
    public init(hfPath: String, keepAlive: String? = nil, options: ModelOptions? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        speculativeStrategy = try container.decodeIfPresent(SpeculativeStrategy.self, forKey: .speculativeStrategy) ?? .classic
